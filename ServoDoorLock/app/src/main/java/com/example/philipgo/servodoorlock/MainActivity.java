...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lock_state_text = findViewById(R.id.lock_state_text);
                            ...
                            handler.post(new Runnable()
                            {
                                ...
                                public void run()
                                {
                                    if(string.equals("3"))
                                    {
                                        ...
                                        lock_state_img.setImageResource(R.drawable.locked_icon); //Changes the lock state iconz
                                    }
    ...
    public boolean BTinit()
    {
        ...
        else
        {
            for(BluetoothDevice iterator : bondedDevices)
            {
                ...
                String DEVICE_ADDRESS = "98:D3:91:FD:66:EF";
